...
urlpatterns = [
    ...
    path('contratos/mandato/<int:pk>/subir-firmado/', views.subir_mandato_firmado, name='subir_mandato_firmado'),
    ...
    path('contratos/arrendamiento/<int:pk>/subir-firmado/', views.subir_arrendamiento_firmado, name='subir_arrendamiento_firmado'),
